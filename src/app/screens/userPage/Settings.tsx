...
export function Settings() {
  ...
  const [memberImage, setMemberImage] = useState<string>(authMember?.memberImage 
  ...
  const handleSubmitButton = async () => {
    try {
      ...
      if (memberUpdateInput.memberNick === "" || memberUpdateInput.memberPhone === "" 
        || memberUpdateInput.memberAddress === "" || memberUpdateInput.memberDesc === "")
      ...
      await sweetTopSmallSuccessAlert("modified successffully", 700);
    } catch (err) {
      console.log(err);
